...
class KNearestNeighbor(object):
    ...
    def compute_distances_no_loops(self, X):
        ...
        # quadratic form (x-y)^2 = x^2-2xy+y^2
        dists = np.sqrt(np.expand_dims(test, axis=1) - 2 * M + np.expand_dims(train, axis=0))
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            # сортирует (по возр.), но возвращает индексы ("бывшие") а не значения
